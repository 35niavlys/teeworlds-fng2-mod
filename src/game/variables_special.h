...
MACRO_CONFIG_INT(SvTeamScoreSpikeGreen, sv_team_score_green, 10, 0, 100, CFGFLAG_SERVER, "Points a team receives for grabbing into green spikes")
MACRO_CONFIG_INT(SvTeamScoreSpikePurple, sv_team_score_purple, 10, 0, 100, CFGFLAG_SERVER, "Points a team receives for grabbing into purple spikes")
...
MACRO_CONFIG_INT(SvPlayerScoreSpikeGreen, sv_player_score_green, 6, 0, 100, CFGFLAG_SERVER, "Points a player receives for grabbing into green spikes")
MACRO_CONFIG_INT(SvPlayerScoreSpikePurple, sv_player_score_purple, 10, 0, 100, CFGFLAG_SERVER, "Points a player receives for grabbing into purple spikes")
